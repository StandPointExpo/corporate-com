...
Route::get('/entrance/forgot-password', function () {
...
Route::post('/entrance/forgot-password', function (Request $request) {
...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::post('/briefs/create', [BriefController::class, 'store'])->name('briefs.store');
    Route::get('/portfolios', [PortfolioController::class, 'index'])->name('portfolios');
    Route::get('/portfolios/{portfolio}', [PortfolioController::class, 'show'])->name('show_images');
    Route::get('/privacy-policy', function () {
        return view('pages.privacy-policy');
