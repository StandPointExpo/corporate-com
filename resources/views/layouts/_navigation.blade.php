...
<nav class="navbar navbar-expand-md navbar-dark fixed-top px-0">
    ...
    <div class="container">
        <div class="row col-12 py-2">
            <div class="collapse navbar-collapse" v-bind:class= "[mobileMenu ? 'show' : '']" id="navbarsExampleDefault">
            ...
            <div class="form-inline my-0 phones-menu col-md-4 col-10 justify-content-sm-start justify-content-md-center">
                <img src="/images/icons/phone_1.svg"><a href="tel:+380442011149">+38 (044) 201-11-49,</a><a href="tel:+380442068704">&nbsp;206-87-04</a>
            </div>
